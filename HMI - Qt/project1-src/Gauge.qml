    ...
    style: CircularGaugeStyle {
        ...
        background: Item {
            ...
            Rectangle {
                ...
                color: "#000000"
                radius: 360
                opacity: 0.05  // Chỉ background mờ
            }

            // Canvas cho màu chuyển động - KHÔNG có opacity
            Canvas {
                ...
                onPaint: {
                    ...
                    for (var i = 0; i < gradientColors.length; i++) {
                        ...
                        // Làm màu sáng hơn bằng cách tăng độ đậm
                        if (gradientColor === "#32D74B") {
                            ctx.strokeStyle = "#40FF5F"; // Xanh sáng hơn
                        } else if (gradientColor === "yellow") {
                            ctx.strokeStyle = "#FFFF00"; // Vàng sáng hơn
                        } else if (gradientColor === "red") {
                            ctx.strokeStyle = "#FF3333"; // Đỏ sáng hơn
                        } else {
